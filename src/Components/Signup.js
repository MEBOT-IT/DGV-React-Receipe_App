...
function Signup() {
  ...
  const handleloginSubmit = (e) => {
    ...
    if (Object.keys(loginnewErrors).length > 0) {
      ...
      navigate('/');
      // setIsUser(true);
      // You can also redirect to another page or perform further actions here.
    }
  };
  ...
  return (
    ...
    <div class="form-container sign-up">
      ...
      <p id='signup-header'>Sign up</p>
        ...
        <div class="link">
          <p id='noacc-link'>You already have an account?<a className={`signin-link ${!isSignUp ? 'active' : ''}`} onClick={handleSignInClick}>sign in</a></p>
        </div>
      </form>
    </div>
